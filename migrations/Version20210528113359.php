 ...
 */
final class Version20210528113359 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE catenews_usernews (catenews_id INT NOT NULL, usernews_id INT NOT NULL, INDEX IDX_703BB5881189443 (catenews_id), INDEX IDX_703BB5829C5A51E (usernews_id), PRIMARY KEY(catenews_id, usernews_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE catenews_usernews DROP FOREIGN KEY FK_703BB5881189443');
        ...
        $this->addSql('ALTER TABLE catenews_usernews DROP FOREIGN KEY FK_703BB5829C5A51E');
