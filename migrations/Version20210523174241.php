 ...
 */
final class Version20210523174241 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE carnet_sante (id INT AUTO_INCREMENT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE vaccins_et_operation (id INT AUTO_INCREMENT NOT NULL, specialiste_id INT NOT NULL, carnet_id INT NOT NULL, nom VARCHAR(255) NOT NULL, action VARCHAR(255) NOT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_6F76A1C66F1A5C10 (specialiste_id), INDEX IDX_6F76A1C6FA207516 (carnet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE visite_medical (id INT AUTO_INCREMENT NOT NULL, specialiste_id INT NOT NULL, carnet_id INT NOT NULL, date_visite DATE NOT NULL, symptome LONGTEXT DEFAULT NULL, diagnostique LONGTEXT DEFAULT NULL, analyses LONGTEXT DEFAULT NULL, UNIQUE INDEX UNIQ_BDDA727C6F1A5C10 (specialiste_id), INDEX IDX_BDDA727CFA207516 (carnet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
